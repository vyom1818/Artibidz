...
<!-- Add the following code for the Category dropdown -->
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item">
				...
				<div class="hs-right">
					...
					<!-- <div class="price">Art Gallery</div> -->
						<h2><span>Artibidz</span> <br>Art & Auction</h2>
	...
	<section class="intro-section spad pb-0">
		...
		<div class="i-slider">
			<ul class="slide">
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('paintings'); ?>">
						<div class="i-item">
							<figure>
								<img src="../images/cat1.jpg" class="fig-size" alt="#">
							</figure>
							<div class=" p-info">
								<h5>Paintings</h5>
								<!-- <p>$319.50</p>
				...
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('Sculpture'); ?>">
						<div class="i-item">
							<figure>
								<img src="../images/cat2.jpg" class="fig-size" alt="#">
							</figure>
							<div class=" p-info">
								<h5>Sculpture</h5>
								<!-- <p>$319.50</p> -->
				...
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('Calligraphy'); ?>">
						<div class="i-item">
							<figure>
								<img src="../images/cat3.jpg" class="fig-size" alt="#">
							</figure>
							<div class=" p-info">
								<h5>Calligraphy</h5>
								<!-- <p>$319.50</p> -->
				...
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('Resin Art'); ?>">
						<div class="i-item">
							<figure>
								<img src="../images/cat4.jpg" class="fig-size" alt="#">
							</figure>
							<div class=" p-info">
								<h5>Resin Art</h5>
								<!-- <p>$319.50</p> -->
				...
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('Sketching'); ?>">
						<div class="i-item">
							<figure>
				...
				<li>
					<a href="fetch_arts1.php?category=<?php echo urlencode('Fine Art Ceramics'); ?>">
						<div class="i-item">
							<figure>
								<img src="../images/wooden girl head.png" alt="#">
							</figure>
							<div class=" p-info">
								<h5>Fine Art Ceramics</h5>
								<!-- <p>$319.50</p> -->
								<!-- <a href="#" class="site-btn btn-line">ADD TO CART</a> -->
							</div>
						</div>
...
<section class="product-section section-title spad">
	<h2 style="color:#141414; margin-bottom:10vh">Our Products</h2>
    <div class="container">
                    ...
                    <div class="mix col-lg-3 col-md-6 best">
						...
						<figure>
						 ...
						 <?php echo "<td><a class='anchor' href='quick_view.php?art_id=$row[art_id]'>"?>
                            ...
                            <div class=" p-info">
								<div class="info">
									<h6><?php echo strtoupper($row['art_name']); ?></h6>
